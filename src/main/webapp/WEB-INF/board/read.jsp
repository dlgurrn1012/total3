...
<div class="container">
  ...
  작성자 : ${board.writeName } 작성일:${board.writeDay} 조회수:${board.readcount}<p>
	...
	<button onclick="location.href='/board/replyForm?idx=${board.idx}&groupid=${board.groupid}&depth=${board.depth}&reOrder=${board.reOrder}&title=${board.title}&requestPage=${requestPage}'">답글쓰기</button>
	<button onclick="location.href='/board/update?idx=${board.idx}'">글 수정</button>
	<button onclick="location.href='/board/delete?idx=${board.idx}'">글 삭제</button>
    </div>
